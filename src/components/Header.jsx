      ...
      <div className="container">
          ...
          <div className="info">
              ...
              <div className="info__icons">
                <a className="info__icons__a" href="https://github.com/luciazabaletag" target="_blank" rel="noreferrer" title="Github"><img className="info__icons__img" src="src/assets/img/github.svg" alt="github icon" /></a>
                <a className="info__icons__a" href="https://www.linkedin.com/in/luciazabaletagirod" target="_blank" rel="noreferrer" title="LinkedIn"><img className="info__icons__img" src="src/assets/img/linkedin.svg" alt="linkedin icon" /></a>
                <a className="info__icons__a info__icons__a-tooltip" onClick={handleCopy}>
                  <img className="info__icons__img" src="src/assets/img/email.svg" alt="email icon" />
